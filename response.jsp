...
*/
  ...
  //Preparing SQL statement for GPS lat and long data
    if((enddate.isEmpty()) || (endtime.isEmpty()))
    {
        sql = "SELECT GPS_lat,GPS_long from sensor_data where Timestamp >= '" + startdate + ' ' + starttime +"' and projectname = '" + pname +"' and username = '" + uname +"'";
    }
    else
    {
        sql = "SELECT GPS_lat,GPS_long from sensor_data where Timestamp >= '" + startdate + ' ' + starttime +"' and Timestamp < '" + enddate + ' ' + endtime +"' and projectname = '" + pname +"' and username = '" + uname +"'";            
    }
    ...
    categoryAxis = new CategoryAxis("Latitute");
    //categoryAxis.setCategoryLabelPositions(CategoryLabelPositions.DOWN_45);
    
    valueAxis = new org.jfree.chart.axis.NumberAxis("Longitute");

    renderer = new  LineAndShapeRenderer();
    
    cplot = new CategoryPlot(jdbcSet, categoryAxis, valueAxis, renderer);
    cplot.setOrientation(PlotOrientation.VERTICAL);
    jChart = new JFreeChart("GPS_Location", JFreeChart.DEFAULT_TITLE_FONT, cplot, true);
    ...
    try{
        ChartUtilities.saveChartAsJPEG(new File("C:/ECE/SensorDataDisplay/web/images/GPSLoc_chart.jpg"), jChart, 1024, 768);
    }catch (IOException e){
        System.out.println("ECE Project....Problem in creating GPS Location chart.");
    }
    
    

//Preparing SQL statement for GPS  Speed
    if((enddate.isEmpty()) || (endtime.isEmpty()))
    {
        sql = "SELECT Timestamp,GPS_Speed from sensor_data where Timestamp >= '" + startdate + ' ' + starttime +"' and projectname = '" + pname +"' and username = '" + uname +"'";
    }
    else
    {
        sql = "SELECT Timestamp,GPS_Speed from sensor_data where Timestamp >= '" + startdate + ' ' + starttime +"' and Timestamp < '" + enddate + ' ' + endtime +"' and projectname = '" + pname +"' and username = '" + uname +"'";            
    }
    ...
    valueAxis = new org.jfree.chart.axis.NumberAxis("GPS Speed");

    renderer = new  LineAndShapeRenderer();
    
    cplot = new CategoryPlot(jdbcSet, categoryAxis, valueAxis, renderer);
    cplot.setOrientation(PlotOrientation.VERTICAL);
    jChart = new JFreeChart("GPS Speed", JFreeChart.DEFAULT_TITLE_FONT, cplot, true);
    ...
    try{
        ChartUtilities.saveChartAsJPEG(new File("C:/ECE/SensorDataDisplay/web/images/GPSSpeed_chart.jpg"), jChart, 1024, 768);
    }catch (IOException e){
        System.out.println("ECE Project....Problem in creating GPS Speed chart.");
    }
...
*/
    ...
    //Preparing SQL statement for BAROMETER DATA
    if((enddate.isEmpty()) || (endtime.isEmpty()))
    {
        sql = "SELECT Timestamp,AtmPressure from sensor_data where Timestamp >= '" + startdate + ' ' + starttime +"' and projectname = '" + pname +"' and username = '" + uname +"'";
    }
    else
    {
        sql = "SELECT Timestamp,AtmPressure from sensor_data where Timestamp >= '" + startdate + ' ' + starttime +"' and Timestamp < '" + enddate + ' ' + endtime +"' and projectname = '" + pname +"' and username = '" + uname +"'";            
    }
    ...
    valueAxis = new org.jfree.chart.axis.NumberAxis("Atmospheric Pressure");

    renderer = new  LineAndShapeRenderer();
    
    cplot = new CategoryPlot(jdbcSet, categoryAxis, valueAxis, renderer);
    cplot.setOrientation(PlotOrientation.VERTICAL);
    jChart = new JFreeChart("Atmospheric Pressure", JFreeChart.DEFAULT_TITLE_FONT, cplot, true);
    ...
    try{
        ChartUtilities.saveChartAsJPEG(new File("C:/ECE/SensorDataDisplay/web/images/AtmP_chart.jpg"), jChart, 1024, 768);
    }catch (IOException e){
        System.out.println("ECE Project....Problem in creating Atmospheric Pressure chart.");
    }
...
<html>
  ...
  HEIGHT="625" BORDER="1" USEMAP="#chart">
        ...
        <hr>
         ...
         <IMG SRC="images/GPSLoc_chart.jpg" WIDTH="1024" 
  HEIGHT="625" BORDER="1" USEMAP="#chart">
         
         <hr>
         
         <IMG SRC="images/GPSSpeed_chart.jpg" WIDTH="1024" 
  HEIGHT="625" BORDER="1" USEMAP="#chart">
  ...
  HEIGHT="625" BORDER="1" USEMAP="#chart">
         ...
         <hr> 
         <IMG SRC="images/AtmP_chart.jpg" WIDTH="1024" 
  HEIGHT="625" BORDER="1" USEMAP="#chart">
    </body>
</html>
