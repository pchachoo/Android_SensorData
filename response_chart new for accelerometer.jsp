...
<%  
  ...
  //Preparing SQL statement for Accelerometer data
    //sql = "SELECT Timestamp,acc_x,acc_y,acc_z from sensor_data";
...
*/
    ...
    JFreeChart jChart = null; //ChartFactory.createLineChart("Accl", "Time", "AccData", jdbcSet, PlotOrientation.VERTICAL,true, true, false);
    
    LineAndShapeRenderer rend = null;
    CategoryPlot cplot = null;
    
    final CategoryAxis categoryAxis1 = new CategoryAxis("Time");
    categoryAxis1.setCategoryLabelPositions(CategoryLabelPositions.DOWN_45);
    
  final ValueAxis valueAxis1 = new org.jfree.chart.axis.NumberAxis("Accelerometer Data");
;
  //renderer = new BarRenderer();
  rend = new  LineAndShapeRenderer();
    
    cplot = new CategoryPlot(jdbcSet, categoryAxis1, valueAxis1, 
  rend);
  cplot.setOrientation(PlotOrientation.VERTICAL);
  jChart = new JFreeChart("Accelerometer", JFreeChart.DEFAULT_TITLE_FONT, 
  cplot, true);
 ...
 0.0f, 0.0f, new Color(16, 89, 172), 0.0f, 0.0f, new Color
  ...
  rend.setSeriesPaint(1, p2);

  Paint p3 = new GradientPaint(
  0.0f, 0.0f, new Color(255, 35, 35), 0.0f, 0.0f, new Color
   (255, 180, 180));

  rend.setSeriesPaint(2, p3);

  cplot.setRenderer(rend);
    
    try{
        ChartUtilities.saveChartAsJPEG(new File("C:/ECE/SensorDataDisplay/web/images/barchart2.jpg"), jChart, 1024, 768);
    }catch (IOException e){
 ...
 "Team ", "", data);
  ...
  final ValueAxis valueAxis = new org.jfree.chart.axis.NumberAxis("Accelerometer Data");
;
  //renderer = new BarRenderer();
  ...
  chart = new JFreeChart("Accelerometer", JFreeChart.DEFAULT_TITLE_FONT, 
  plot, true);
...
<html>
    ...
    <body>
        ...
        <IMG SRC="images/barchart2.jpg" WIDTH="1024" 
  HEIGHT="600" BORDER="1" USEMAP="#chart">
        
        <hr>
        
         <IMG SRC="images/barchart2.jpg" WIDTH="1024" 
  HEIGHT="768" BORDER="1" USEMAP="#chart">
